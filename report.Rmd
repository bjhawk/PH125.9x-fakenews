...
```{r test_rf_models_training, eval=FALSE}
...
> explain what an svm is and what it does

> demonstrate on dummy data

> make models

> test models on training sets

```{r, test_svm_models_training, eval=FALSE}
# Afinn SVM
...
```{r test_rf_models_testing, eval=FALSE}
...
```{r test_svm_models_testing, eval=FALSE}
# Afinn SVM
